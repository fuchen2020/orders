<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"F:\order\orders\public/../application/index\view\index\configlists.php";i:1525452105;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                <tr class="gradeC">
                                    ...
                                    <td><?php echo $data['zhushi']; ?></td>
                                    <td >
                                       <a onclick="edit(<?php echo $data['id']; ?>)" class="btn btn-warning">修改</a>
                                    </td>
                                </tr>
