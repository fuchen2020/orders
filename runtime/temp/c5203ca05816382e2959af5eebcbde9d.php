<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"F:\order\orders\public/../application/index\view\index\userlists.php";i:1525433926;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                <tr class="gradeC">
                                    ...
                                    <td ><?php echo $data['referee_id']; ?></td>
                                    <td ><?php echo $data['point']; ?></td>
                                    <td ><?php echo $data['status']==1?'正常':'冻结'; ?></td>
                                    <td ><?php echo $data['created_at']; ?></td>
                                    <td >
                                       <a href="/userFrozen?type=1&id=<?php echo $data['id']; ?>" class="btn btn-warning">冻结</a>
                                        <a href="/userFrozen?type=2&id=<?php echo $data['id']; ?>" class="btn btn-info">解冻</a>
                                    </td>
                                </tr>
