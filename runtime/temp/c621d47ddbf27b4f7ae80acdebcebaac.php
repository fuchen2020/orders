<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\order\orders\public/../application/index\view\index\index.php";i:1525438586;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="J_menuItem" href="/addCard"><i class="fa fa-columns"></i> <span class="nav-label">卡密生成</span></a>
                    </li>
                    <li>
